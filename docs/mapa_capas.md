...
Servicios WMTS ICGC
https://www.icgc.cat/es/Administracion-y-empresa/Servicios/Servicios-en-linea-Geoservicios/WMS-y-teselas-Cartografia-de-referencia/WMS-WMTS-rapidos-de-cartografia-raster/WMTS-de-cartografia-raster-en-coordenadas-no-UTM
...
const controlLayers = new L.Control.styledLayerControl(
    baseMaps,
    serveis,
    options,
);
...
<script
    ...
    src="http://maps.googleapis.com/maps/api/js?key=[TU_API_KEY]"
></script>
```
